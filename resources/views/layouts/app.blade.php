        ...
        <!--dropdownmenu-->
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="{{ url('/producten/3')}}"><i class="fas fa-box m-r-5"></i>Witgoed</a>
                </div>
            </li>
        </ul>
        ...
        @auth('admin')
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="{{ route('admin.dashboard')}}"><i class="fas fa-tachometer-alt m-r-5"></i>Admin-Dashboard</a>
